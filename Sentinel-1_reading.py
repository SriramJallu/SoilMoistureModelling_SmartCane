...
# last_vv_dates = vv_series.index.to_series().reindex(train_df["Date"]).ffill()
# train_df["Days_Since_VV"] = (train_df["Date"].reset_index(drop=True) - last_vv_dates.reset_index(drop=True)).dt.days
...
# last_vv_dates = vv_series.index.to_series().reindex(test_df["Date"]).ffill()
# test_df["Days_Since_VV"] = (test_df["Date"].reset_index(drop=True) - last_vv_dates.reset_index(drop=True)).dt.days
