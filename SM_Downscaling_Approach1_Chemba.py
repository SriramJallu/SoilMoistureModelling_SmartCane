...
ndvi_path = "../../Data/Chemba_Buffer/VIIRS_NDVI_4326_2015_2020_Chemba_Buffer_1km.tif"
lst_day_path = "../../Data/Chemba_Buffer/VIIRS_LST_Day_4326_2015_2020_Chemba_Buffer_1km.tif"
lst_night_path = "../../Data/Chemba_Buffer/VIIRS_LST_Night_4326_2015_2020_Chemba_Buffer_1km.tif"
dem_path = "../../Data/Chemba_Buffer/DEM_Map_Chemba_Buffer_90m.tif"
slope_path = "../../Data/Chemba_Buffer/Slope_Map_Chemba_Buffer_90m.tif"
soil_texture_path = "../../Data/Chemba_Buffer/SoilTexture_Map_Chemba_Buffer_b0_250m.tif"
smap_sm_am_path = "../../Data/Chemba_Buffer/SMAP_L3_2015_2020_SoilMoisture_AM_Chemba_Buffer_Daily.tif"
smap_sm_pm_path = "../../Data/Chemba_Buffer/SMAP_L3_2015_2020_SoilMoisture_PM_Chemba_Buffer_Daily.tif"
...
modis_et_path = "../../Data/Chemba_Buffer/MODIS_ET_8Day_2015_2020_Chemba_Buffer_500m.tif"
modis_daily_et_path = "../../Data/Chemba_Buffer/MODIS_ET_Daily_2015_2020_Chemba_Buffer.tif"
precip_era5_path = "../../Data/Chemba_Buffer/ERA5_2015_2020_Precip_Chemba_Buffer_Daily.tif"
...
precip_resampled = resampling_dynamic_data(precip_data, precip_meta, smap_sm_shape)
...
dynamic_inputs_stack = np.stack([ndvi_resampled, lst_day_resampled, lst_night_resampled, et_resampled, precip_resampled], axis=-1)
...
# model.save_model("../../Models/SM_Downscaling_Model_Approach1_Chemba_Buffer.json")

model = xgb.XGBRegressor()
model.load_model('../../Models/SM_Downscaling_Model_Approach1_Chemba_Buffer.json')
model2 = xgb.XGBRegressor()
model2.load_model('../../Models/SM_Downscaling_Model_Approach1_NL.json')
...
y_pred_1km_model2 = model2.predict(X_1km_scaled)
pred_grid_model2 = np.full(X_1km.shape[:-1], np.nan)
pred_grid_model2[valid_mask] = y_pred_1km_model2.flatten()
pred_map_model2 = pred_grid_model2.reshape((smap_sm_filled.shape[0], lst_day_meta["height"], lst_day_meta["width"]))
...
pred_series_model2 = pred_map_model2[:, row, col]
...
combined_df = pd.DataFrame({
    "pred_model1": pred_series,
    "pred_model2": pred_series_model2,
...
axes[0].plot(combined_df.index, combined_df["pred_model1"], label="Chemba_Model SM", linewidth=2)
axes[0].plot(combined_df.index, combined_df["pred_model2"], label="NL_Model SM", linewidth=2)
...
axes[0].set_title("NL Model vs Chemba Model (2020)", fontsize=14)
axes[0].legend()
axes[0].grid(True)
...
# output_path = "../../Data/Chemba_Buffer/SMAP_downscaled_appraoch1_smap_Chemba_Model_Chemba_Buffer.tif"
