...
sm_test_path = "../../Data/dataverse_files/1_station_measurements/2_calibrated/ITCSM_01_cd.csv"
gssm_sm_train = "../../Data/GSSM/GSSM_2016_2020_SM_NL_Daily_1km.tif"

weather_train = stack_weather(era5_train_paths)[:1461]
weather_test = stack_weather(era5_train_paths)[1461:1461+366]

sm_train = read_tif(smap_sm_am_train)[:1461]
sm_test = read_tif(smap_sm_am_train)[1461:1461+366]
